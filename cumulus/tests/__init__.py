...
class CumulusTests(TestCase):
    ...
    def test_image_content_type(self):
        ...
        cloud_image = openstack_storage.container.get_object(self.thing.image.name)
    ...
    def test_text_content_type(self):
        ...
        cloud_doc = openstack_storage.container.get_object(self.thing.document.name)
    ...
    def test_custom_content_type(self):
        ...
        cloud_custom = openstack_storage.container.get_object(self.thing.custom.name)
        #import ipdb; ipdb.set_trace()
